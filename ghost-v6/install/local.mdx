...
description: Fast-track local install for getting Ghost running on your computer or setup for doing theme development
---
...
* [Python 3 and setuptools](/faq/python-setuptools-required-sqlite3) for building SQLite3
...
[Ghost-CLI](/ghost-cli/) is a commandline tool to help you get Ghost installed and configured for use, quickly and easily. The npm module can be installed with `npm` or `yarn` on a local machine, depending on your preference.
...
To work on a [Ghost Handlebars Theme](/themes/) locally, your custom theme should always be placed in the top-level `/content/themes/` directory.
