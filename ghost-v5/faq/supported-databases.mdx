---
title: "What Databases Are Supported In Production?"
description: MySQL 8 is the only supported database in production.
---
...
This will happen automatically if you update your Ubuntu install to [Ubuntu 20](https://www.digitalocean.com/community/tutorials/how-to-upgrade-to-ubuntu-20-04-focal-fossa). Alternatively you can update MySQL using your package manager of choice.
